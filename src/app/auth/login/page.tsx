...
import { Phone, Lock, HeartPulse, ArrowRight, Sparkles, ArrowLeft, AlertCircle, CheckCircle2, Leaf, Loader2, Eye, EyeOff, Users } from 'lucide-react'
            ...
            <div className="relative">
              ...
              <div className="mt-3 pt-3 border-t border-border/50">
                <p className="text-xs font-semibold text-primary mb-2 flex items-center gap-1">
                  ...
                  Family with Linked Elders (logs in as Family)
                </p>
                <div className="space-y-2">
                  <div className="p-2.5 bg-white/80 rounded-xl border border-border/50">
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-medium text-muted-foreground">1 elder</span>
                  ...
                  <div className="p-2.5 bg-white/80 rounded-xl border border-border/50">
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-medium text-muted-foreground">2 elders</span>
                      <code className="text-xs font-mono text-foreground">9000000009 / 1234</code>
                    </div>
                    <p className="text-[10px] text-muted-foreground mt-1">Vikram [Family] → Kamla + Gopal [Elders]</p>
                  </div>
                </div>
              </div>
            </div>
